...
#' @param WFarea An sf object. The polygon of the wind farm area of interes
#' @noRd 
#' @return a numeric value representing the proportion of lines that overlap the specific wind farm area
#' @export
